...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`KR Digital Media`}</title>

        <meta
          name="description"
          content="Experience the power of connectivity with KR Digital Media - Your ultimate destination for comprehensive Social Media Services and Solutions."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1535303311164-664fc9ec6532?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzb2NpYWwlMjBtZWRpYXxlbnwwfHx8fDE2OTAxOTgzNjZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the power of connectivity with KR Digital Media - Your ultimate destination for comprehensive Social Media Services and Solutions.`}
            </Text>
            <Box
